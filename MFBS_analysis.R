...
mat <-lmer(log(Area_BS) ~ Population*Treatment +  (1|Counter/DamID),
           data = imagej[which(imagej$Blood_Space_Type=="Maternal"),])
check_model(mat)
anova(mat)

matPm <-lmer(log(Pm_BS) ~ Population*Treatment + (1|Counter/DamID),
             data = imagej[which(imagej$Blood_Space_Type=="Maternal"),])
check_model(matPm)
anova(matPm)

relmatPm <-lmer(log(Pm_BS) ~ Population*Treatment + log(Area_BS) + (1|Counter/DamID),
             data = imagej[which(imagej$Blood_Space_Type=="Maternal"),])
check_model(relmatPm)
anova(relmatPm)

fet <-lmer(log(Area_BS) ~ Population*Treatment +  (1|Counter/DamID),
           data = imagej[which(imagej$Blood_Space_Type=="Fetal"),])
check_model(fet)
anova(fet)
pairs(emmeans(fet, ~Population*Treatment), adjust = "BH")

fetPm <-lmer(log(Pm_BS) ~ Population*Treatment + (1|Counter/DamID),
             data = imagej[which(imagej$Blood_Space_Type=="Fetal"),])
check_model(fetPm)
anova(fetPm)

relfetPm <-lmer(log(Pm_BS) ~ Population*Treatment + log(Area_BS) + (1|Counter/DamID),
                data = imagej[which(imagej$Blood_Space_Type=="Fetal"),])
...
matPm <-lmer(log(Pm_BS) ~ Population + Treatment*log(Area_BS) + (1|Counter/DamID),
             data = imagej[which(imagej$Blood_Space_Type=="Maternal"),])
check_model(matPm)
anova(matPm)
pairs(emmeans(matPm, ~Population))
...
fetPm <-lmer(log(Pm_BS) ~ Population + Treatment*log(Area_BS) +  (1|Counter/DamID),
             data = imagej[which(imagej$Blood_Space_Type=="Fetal"),])
check_model(fetPm)
anova(fetPm)
pairs(emmeans(fetPm, ~Population))
